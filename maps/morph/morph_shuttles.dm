...
/datum/shuttle/autodock/ferry/escape_pod/morphpod
	category = /datum/shuttle/autodock/ferry/escape_pod/morphpod
...
//Pods
#define morph_ESCAPE_POD(NUMBER) \
/datum/shuttle/autodock/ferry/escape_pod/morphpod/escape_pod##NUMBER { \
...
/datum/shuttle/autodock/overmap/exploration_shuttle
	...
	ceiling_type = /turf/simulated/floor/shuttle_ceiling/morph

/obj/effect/shuttle_landmark/morph/hangar/exploration_shuttle
	name = "Charon Hangar"
	landmark_tag = "nav_hangar_calypso"
	base_area = /area/quartermaster/hangar
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/morph/deck1/exploration_shuttle
	name = "Space near Forth Deck"
	landmark_tag = "nav_deck1_calypso"

/obj/effect/shuttle_landmark/morph/deck2/exploration_shuttle
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_calypso"

/obj/effect/shuttle_landmark/morph/deck3/exploration_shuttle
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_calypso"

/obj/effect/shuttle_landmark/morph/deck4/exploration_shuttle
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_calypso"

/obj/effect/shuttle_landmark/morph/deck5/exploration_shuttle
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_calypso"

/obj/effect/shuttle_landmark/transit/morph/exploration_shuttle
	name = "In transit"
...
/obj/effect/shuttle_landmark/morph/hangar/guppy
	name = "Guppy Hangar"
	landmark_tag = "nav_hangar_guppy"
	base_area = /area/quartermaster/hangar
	base_turf = /turf/simulated/floor/plating

/obj/effect/shuttle_landmark/morph/deck1/guppy
	name = "Space near Forth Deck"
	landmark_tag = "nav_deck1_guppy"

/obj/effect/shuttle_landmark/morph/deck2/guppy
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_guppy"

/obj/effect/shuttle_landmark/morph/deck3/guppy
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_guppy"

/obj/effect/shuttle_landmark/morph/deck4/guppy
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_guppy"

/obj/effect/shuttle_landmark/morph/deck5/guppy
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_guppy"

/obj/effect/shuttle_landmark/transit/morph/guppy
	name = "In transit"
...
/obj/effect/shuttle_landmark/morph/hangar/aquila
	name = "Aquila Hangar"
	landmark_tag = "nav_hangar_aquila"
	docking_controller = "aquila_shuttle_dock_airlock"
	base_turf = /turf/simulated/floor/reinforced/airless

/obj/effect/shuttle_landmark/morph/deck1/aquila
	name = "Space near Forth Deck"
	landmark_tag = "nav_deck1_aquila"

/obj/effect/shuttle_landmark/morph/deck2/aquila
	name = "Space near Third Deck"
	landmark_tag = "nav_deck2_aquila"

/obj/effect/shuttle_landmark/morph/deck3/aquila
	name = "Space near Second Deck"
	landmark_tag = "nav_deck3_aquila"

/obj/effect/shuttle_landmark/morph/deck4/aquila
	name = "Space near First Deck"
	landmark_tag = "nav_deck4_aquila"

/obj/effect/shuttle_landmark/morph/deck5/aquila
	name = "Space near Bridge"
	landmark_tag = "nav_bridge_aquila"

/obj/effect/shuttle_landmark/transit/morph/aquila
	name = "In transit"
