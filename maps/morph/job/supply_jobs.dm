/datum/job/qm
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/supply/deckofficer
	...
	access = list(
		...
		access_mining, access_mining_office, access_mining_station, access_commissary, access_teleporter, access_eva, access_morph_fax,
...
/datum/job/cargo_tech
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/supply/tech
	allowed_branches = list(
		/datum/mil_branch/ftu_civil,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/morph/crew/supply/contractor
	)
	allowed_ranks = list(
...
/datum/job/mining
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/passenger/research/prospector
