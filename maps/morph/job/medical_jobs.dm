/datum/job/senior_doctor
	...
	alt_titles = list(
		"Surgeon")
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/medical/senior
	allowed_branches = list(
		/datum/mil_branch/ftu_civil,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/morph/crew/medical/contractor/senior
	)
	allowed_ranks = list(
...
/datum/job/doctor
	...
	alt_titles = list(
		"Paramedic",
		"Corpsman")
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/medical/doctor
	allowed_branches = list(
		/datum/mil_branch/ftu_civil,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/morph/crew/medical/contractor
	)
	allowed_ranks = list(
...
/datum/job/chemist
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/medical/contractor/chemist
...
/datum/job/psychiatrist
	...
	minimal_player_age = 0
	supervisors = "the Chief Medical Officer"
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/medical/counselor
	alt_titles = list(
		"Psychiatrist",
		"Psionic Counselor" = /decl/hierarchy/outfit/job/morph/crew/medical/counselor/mentalist,
		"Mentalist" = /decl/hierarchy/outfit/job/morph/crew/medical/counselor/mentalist
