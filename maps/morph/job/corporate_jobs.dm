/datum/job/liaison
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/passenger/workplace_liaison
	...
	access = list(
		...
		access_nanotrasen, access_commissary, access_morph_fax,
...
/datum/job/bodyguard
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/passenger/corporate_bodyguard
	allowed_branches = list(/datum/mil_branch/civilian)
	allowed_ranks = list(/datum/mil_rank/civ/contractor)
	...
	access = list(
		...
		access_sec_guard, access_morph_fax, access_radio_serv
	)
