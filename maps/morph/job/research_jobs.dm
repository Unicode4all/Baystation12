/datum/job/senior_scientist
	...
	alt_titles = list(
		"Research Supervisor")
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/research/senior_scientist
	...
	access = list(
		...
		access_petrov_maint, access_morph_fax, access_radio_sci, access_radio_exp
	)
...
/datum/job/scientist
	...
	outfit_type = /decl/hierarchy/outfit/job/morph/crew/research/scientist
	allowed_branches = list(
		/datum/mil_branch/ftu_civil,
	...
	allowed_ranks = list(
		/datum/mil_rank/ftu_civil/o1,
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/morph/passenger/research/scientist,
	)
	...
	access = list(
		...
		access_petrov_analysis, access_petrov_phoron, access_petrov_toxins, access_petrov_chemistry, access_morph_fax,
...
/datum/job/scientist_assistant
	...
	alt_titles = list(
		"Custodian" = /decl/hierarchy/outfit/job/morph/passenger/research/assist/janitor,
		"Testing Assistant" = /decl/hierarchy/outfit/job/morph/passenger/research/assist/testsubject,
		"Intern",
		"Clerk",
		"Field Assistant")

	outfit_type = /decl/hierarchy/outfit/job/morph/crew/research
	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/ftu_civil
	)
	allowed_ranks = list(
		...
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/morph/passenger/research/assist
	)
	max_skill = list(   SKILL_ANATOMY     = SKILL_MAX,
	                    SKILL_DEVICES     = SKILL_MAX,
	                    SKILL_SCIENCE     = SKILL_MAX)
