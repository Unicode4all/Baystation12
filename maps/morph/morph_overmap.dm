/obj/effect/overmap/visitable/ship/morph
	name = "FTV Morpheus"
	desc = "A fresh-out-of-shipyard FTMC-Katabasis-class medium frigate, broadcasting FTU codes and the designation \"FTV Morpheus, FTRD-2-45-C\"."
	fore_dir = WEST
	vessel_mass = 50000
	...
	initial_restricted_waypoints = list(
		...
		"Ascent Caulship" = list("nav_ascent_caulship_morph"), //restricts caulship specific docking waypoint on deck 4 starboard side
		...
		"ITV The Reclaimer" = list("nav_hangar_gantry_morph"), //gantry shuttles
		"ITV Vulcan" = list("nav_hangar_gantry_morph_two"),
		"ITV Spiritus" = list("nav_hangar_gantry_morph_three"),
...
/obj/effect/overmap/visitable/ship/landable/exploration_shuttle
	name = "Ikelos"
	desc = "An SSE-U11 long range shuttle, broadcasting FTU codes and the callsign \"Morpheus-2 Ikelos\"."
	shuttle = "Ikelos"
...
/obj/effect/overmap/visitable/ship/landable/aquila
	name = "Aquila"
	desc = "A PM-24 modular transport, broadcasting SCGEC codes and the callsign \"morph-1 Aquila\"."
	shuttle = "Aquila"
	vessel_mass = 10000
...
/obj/effect/overmap/visitable/ship/landable/guppy
	name = "Guppy"
	desc = "An SSE-U3 utility pod, broadcasting SCGEC codes and the callsign \"morph-3 Guppy\"."
	shuttle = "Guppy"
...
/obj/effect/overmap/visitable/ship/morph/Initialize()
	. = ..()
