/datum/map/morph
	...
	base_floor_area = /area/morphexterior
...
//  Engineering Deck (Z-0)
/area/hallway/primary/engdeck/primary
	name = "\improper Engineering Deck Primary Hallway"
	icon_state = "hallF"

/area/maintenance/engdeck/port
	name = "\improper Engineering Deck Port Maintenance"
	icon_state = "hallF"
...
/area/exploration_shuttle/
	name = "\improper Thanatos"
	icon_state = "shuttlered"
	base_turf = /turf/simulated/floor/plating
	area_flags = AREA_FLAG_RAD_SHIELDED | AREA_FLAG_ION_SHIELDED

/area/exploration_shuttle/cockpit
	name = "\improper Thanatos - Cockpit"
	req_access = list(access_expedition_shuttle)

/area/exploration_shuttle/atmos
	name = "\improper Thanatos - Atmos Compartment"

/area/exploration_shuttle/power
	name = "\improper Thanatos - Power Compartment"

/area/exploration_shuttle/crew
	name = "\improper Thanatos - Crew Compartment"

/area/exploration_shuttle/cargo
	name = "\improper Thanatos - Cargo Bay"

/area/exploration_shuttle/airlock
	name = "\improper Thanatos - Airlock Compartment"
...
/area/bridge
	name = "\improper SEV morph Bridge"
	icon_state = "bridge"
	req_access = list(access_bridge)
