/datum/map/morph
	...
	emergency_shuttle_called_sound = sound('sound/AI/morph/abandonship.ogg', volume = 45)

	emergency_shuttle_recall_message = "Attention all hands: emergency evacuation sequence aborted. Return to normal operating conditions."

	command_report_sound = sound('sound/AI/morph/commandreport.ogg', volume = 45)
	...
	grid_check_sound = sound('sound/AI/morph/poweroff.ogg', volume = 45)

	grid_restored_message = "Ship power to the %STATION_NAME% will be restored at this time"
	grid_restored_sound = sound('sound/AI/morph/poweron.ogg', volume = 45)

	meteor_detected_sound = sound('sound/AI/morph/meteors.ogg', volume = 45)
	...
	radiation_detected_sound = sound('sound/AI/morph/radiation.ogg', volume = 45)

	space_time_anomaly_sound = sound('sound/AI/morph/spanomalies.ogg', volume = 45)
	...
	unidentified_lifesigns_sound = sound('sound/AI/morph/aliens.ogg', volume = 45)

	lifesign_spawn_sound = sound('sound/AI/morph/aliens.ogg', volume = 45)

	electrical_storm_moderate_sound = sound('sound/AI/morph/electricalstormmoderate.ogg', volume = 45)
	electrical_storm_major_sound = sound('sound/AI/morph/electricalstormmajor.ogg', volume = 45)

/datum/map/morph/level_x_biohazard_sound(var/bio_level)
	switch(bio_level)
		if(7)
			return sound('sound/AI/morph/outbreak7.ogg', volume = 45)
		else
			return sound('sound/AI/morph/outbreak5.ogg', volume = 45)
