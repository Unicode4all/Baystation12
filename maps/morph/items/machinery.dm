//Shouldn't be a lot in here, only morph versions of existing machines that need a different access req or something along those lines.

/obj/machinery/vending/medical/morph
	req_access = list(access_medical)

/obj/machinery/drone_fabricator/morph
	fabricator_tag = "SEV morph Maintenance"

/obj/machinery/drone_fabricator/morph/adv
	name = "advanced drone fabricator"
	fabricator_tag = "SFV Arrow Maintenance"
	drone_type = /mob/living/silicon/robot/drone/construction

//telecommunications gubbins for morph-specific networks
