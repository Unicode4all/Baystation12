/obj/item/clothing/accessory/solgov
	...
	icon = 'maps/morph/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/morph/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'maps/morph/icons/mob/onmob_accessories_solgov.dmi')
...
/obj/item/clothing/accessory/solgov/morph_patch
	name = "\improper morph mission patch"
	desc = "A fire resistant shoulder patch, worn by the personnel involved in the morph Project."
	icon_state = "morphpatch"
...
/obj/item/clothing/accessory/armor/tag/solgov
	...
	icon_override = 'maps/morph/icons/obj/obj_accessories_solgov.dmi'
	icon = 'maps/morph/icons/obj/obj_accessories_solgov.dmi'
	accessory_icons = list(slot_w_uniform_str = 'maps/morph/icons/mob/onmob_accessories_solgov.dmi', slot_wear_suit_str = 'maps/morph/icons/mob/onmob_accessories_solgov.dmi')
	icon_state = "solflag"
