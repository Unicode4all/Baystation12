...
/obj/item/clothing/head/helmet/space/void/engineering/alt/sol
	...
	item_icons = list(slot_head_str = 'maps/morph/icons/mob/onmob_head_solgov.dmi')
	sprite_sheets = list(
		SPECIES_UNATHI = 'maps/morph/icons/mob/unathi/onmob_head_solgov_unathi.dmi',
		SPECIES_SKRELL = 'maps/morph/icons/mob/skrell/onmob_head_solgov_skrell.dmi',
		)
	sprite_sheets_obj = list(
		SPECIES_UNATHI = 'maps/morph/icons/obj/unathi/obj_head_solgov_unathi.dmi',
		SPECIES_SKRELL = 'maps/morph/icons/obj/skrell/obj_head_solgov_skrell.dmi',
		)
