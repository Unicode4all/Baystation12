...
/datum/map/morph/setup_events()
	map_event_container = list(
				num2text(EVENT_LEVEL_MODERATE)	= new/datum/event_container/moderate/morph,
				num2text(EVENT_LEVEL_MAJOR) 	= new/datum/event_container/major/morph
			)
...
/datum/event_container/moderate/morph
...
/datum/event_container/major/morph
	available_events = list(
