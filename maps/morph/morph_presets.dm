...
/datum/map/morph/get_network_access(var/network)
	switch(network)
		if(NETWORK_AQUILA)
...
// Substation SMES
/obj/machinery/power/smes/buildable/preset/morph/substation
...
/obj/machinery/power/smes/buildable/preset/morph/substation_full
...
/obj/machinery/power/smes/buildable/preset/morph/engine_main
...
// Shuttle SMES
/obj/machinery/power/smes/buildable/preset/morph/shuttle
	uncreated_component_parts = list(
...
/obj/machinery/power/smes/buildable/preset/morph/hangar
	uncreated_component_parts = list(
		/obj/item/weapon/stock_parts/smes_coil/super_io = 2)
	_input_maxed = TRUE
	_output_maxed = TRUE
...
/datum/map/morph/default_internal_channels()
	return list(
