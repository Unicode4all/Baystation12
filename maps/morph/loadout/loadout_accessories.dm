...
/datum/gear/accessory/morph_patch
	display_name = "morph mission patch"
	path = /obj/item/clothing/accessory/solgov/morph_patch
	description = "A shoulder patch representing the SEV morph and its mission. Given to all the oddjobs pulled from various branches to work on the morph."
