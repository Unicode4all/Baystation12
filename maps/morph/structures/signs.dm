/obj/structure/sign/dedicationplaque
	name = "\improper FTV Morpheus dedication plaque"
	icon_state = "lightplaque"

/obj/structure/sign/dedicationplaque/Initialize()
	. = ..()
	desc = "F.T.V. Morpheus - Katabasis Class - Free Trade Union universal ship registry 66342 - Shiva Fleet Yards, Mars - First Vessel To Bear The Name - Launched [GLOB.using_map.game_year - 5] - Sol Central Government - 'Never was anything great achieved without danger.'"
...
/obj/structure/sign/ecplaque
	...
	icon = 'maps/morph/icons/obj/solgov-decals.dmi'
	icon_state = "ecplaque"
...
/obj/effect/floor_decal/scglogo
	alpha = 230
	icon = 'maps/morph/icons/obj/solgov_floor.dmi'
	icon_state = "center"
...
/obj/structure/sign/memorial
	...
	icon = 'maps/morph/icons/obj/solgov-64x.dmi'
	icon_state = "memorial"
	density = 1
	anchored = 1
	pixel_x = -16
