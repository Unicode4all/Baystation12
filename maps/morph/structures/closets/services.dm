 ...
 * morph Service
 */
/decl/closet_appearance/secure_closet/morph/hydroponics
	extra_decals = list(
...
/obj/structure/closet/chefcloset_morph
	name = "chef's closet"
	desc = "It's a storage unit for foodservice equipment."
	closet_appearance = /decl/closet_appearance/wardrobe/black

/obj/structure/closet/chefcloset_morph/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_morph //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/morph/hydroponics

/obj/structure/closet/secure_closet/hydroponics_morph/WillContain()
	return list(
...
/obj/structure/closet/jcloset_morph/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/bar_morph
	name = "bar locker"
	desc = "It's a storage unit for bar equipment."
	req_access = list(access_bar)

/obj/structure/closet/secure_closet/bar_morph/WillContain()
	return list(
