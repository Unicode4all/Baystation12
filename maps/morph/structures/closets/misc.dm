/decl/closet_appearance/secure_closet/morph/sol
	color = COLOR_BABY_BLUE
	extra_decals = list(
		"stripe_vertical_mid_full" =  COLOR_OFF_WHITE
	)

/decl/closet_appearance/secure_closet/morph/sol/rep
	color = COLOR_BABY_BLUE
	extra_decals = list(
...
/decl/closet_appearance/secure_closet/morph/corporate
	color = COLOR_BOTTLE_GREEN
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_OFF_WHITE
	)

/decl/closet_appearance/secure_closet/morph/corporate/liaison
	extra_decals = list(
		"stripe_vertical_left_full" =  COLOR_OFF_WHITE,
		"stripe_vertical_right_full" = COLOR_OFF_WHITE,
...
/obj/structure/closet/secure_closet/liaison
	...
	closet_appearance = /decl/closet_appearance/secure_closet/morph/corporate/liaison
...
/obj/structure/closet/secure_closet/liaison/WillContain()
	return list(
		...
		/obj/item/device/radio/headset/heads/morphntcommand,
		/obj/item/device/radio/headset/heads/morphntcommand/alt
	)

/decl/closet_appearance/secure_closet/morph/corporate/bodyguard
	extra_decals = list(
		"stripe_vertical_left_full" =  COLOR_OFF_WHITE,
		"stripe_vertical_right_full" = COLOR_OFF_WHITE,
...
/obj/structure/closet/secure_closet/bodyguard
	...
	closet_appearance = /decl/closet_appearance/secure_closet/morph/corporate/bodyguard
...
/obj/structure/closet/secure_closet/bodyguard/WillContain()
	return list(
		...
		/obj/item/device/radio/headset/heads/morphcorp,
		/obj/item/device/radio/headset/heads/morphcorp/alt,
...
/obj/structure/closet/secure_closet/representative
	...
	closet_appearance = /decl/closet_appearance/secure_closet/morph/sol/rep
...
/obj/structure/closet/secure_closet/crew
	...
	closet_appearance = /decl/closet_appearance/secure_closet/morph/sol
...
/obj/structure/closet/secure_closet/crew/research
	...
	closet_appearance = /decl/closet_appearance/secure_closet/morph/corporate
